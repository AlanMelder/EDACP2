...
#Subsetting Baltimore & LA data.
vehicle_emission_la_balt <- vehicle_mergeSCCNEI[ which(vehicle_mergeSCCNEI$fips=="24510"|vehicle_mergeSCCNEI$fips=="06037"), ]

# Summing totals by year
vehicle_emission_la_balt_sum <- aggregate(Emissions ~ year + fips, vehicle_emission_la_balt, sum)
